      ...
      <div class="row">
        <div class="col-md-12">
          <fieldset>
            ...
            <span>Favor de pagar en la sucursal antes del 
              <label> <?php 
            ...
            <?php
              require '../admin/autoload.php';
              $pedido = new Kawschool\Pedido;
              $info_cuenta= $pedido->mostrar3();
              $cantidad = count($info_cuenta);
              if($cantidad > 0){
                $c=0;
                for($x =0; $x < $cantidad; $x++){
                  $c++;
            ...
            <div class="row">
              <div class="col-md-12">
                <legend>Cuenta Bancaria a depositar</legend>
                <div class="form-group">
                  <label>Nombre del vendedor</label>
                  <input value="<?php print $item['nombre'] ?>" type="text" class="form-control" readonly>
                </div>
                <div class="form-group">
                  <label>Apellidos del vendedor</label>
                  <input value="<?php print $item['apellidos'] ?>" type="text" class="form-control" readonly>
                </div>
                <div class="form-group">
                  <label>Número de cuenta bancaria</label>
                  <input value="<?php print $item['no_cuenta'] ?>" type="text" class="form-control" readonly>
                </div>
                <div class="form-group">
                  <label>Nombre del banco</label>
                  <input value="<?php print $item['banco'] ?>" type="text" class="form-control" readonly>
                </div>
              </div>
           </div>
          </fieldset>
