          ...
          <div class="col-md-13">
            <fieldset>
              ...
              <form action="completar_pedido.php" method="post">
                ...
                <div class="form-group">
                  <label>Teléfono<span class="orange_color">*</span></label>
                  <input type="text" class="form-control" name="telefono" required>
                </div>
                
                <div class="form-group">
                  <label>Dirección<span class="orange_color">*</span></label>
                  <input type="text" class="form-control" name="direccion" required>
                </div>
                
                <div class="form-group">
                  <label>Código Postal<span class="orange_color">*</span></label>
                ...
                <br>
                <div class="form-group">
                  <label>Nombre del Tarjetahabiente<span class="orange_color">*</span></label>
                  <input type="text" class="form-control" name="nom_tarjetaH" required>
                </div>
                
                <div class="form-group">
                  <label>Número de Tarjeta<span class="orange_color">*</span></label>
                  <input type="text" class="form-control" name="num_tarjeta" maxlength="12" required>
                </div>
                
                <div class="form-group">
                  <label>CVC<span class="orange_color">*</span></label>
                  <input type="text" class="form-control" name="cvc" maxlength="4" required>
                </div>
                
                <div class="form-group">
                  <label>Fecha de expiración (MM/AA)<span class="orange_color">*</span></label>
                  <input style="width:90px; display:iniline-block;" class="form-control" placeholder="MM/AA" type="text" name="exp_cvc" maxlength="7" required>
                </div>
                <br>
