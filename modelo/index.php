            ...
            <div class="row">
               ...
               <div class="col-md-5">
                  <div class="full slider_cont_section">
                     ...
                     <p ALIGN="JUSTIFY">Cuando se trata de mantener felices a las mascotas, la mayoría estamos de acuerdo en que esto implica proporcionarles lo esencial: comida nutritiva, juguetes divertidos, una cama cómoda y mucho amor. </p>
                     <div class="button_section">
                        <a href="about.php">Leer Más...</a>
               ...
               <div class="col-md-6">
                  <div class="full blog_cont">
                     ...
                     <p ALIGN="JUSTIFY">Estamos aquí para brindar algo más que suministros y servicios;  al ser la cadena de tiendas de mascotas líder en el mercado mexicano
                        ...
                        animal y lo compartimos con todos los dueños de mascotas en México.</p>
                  </div>
               </div>
            </div>
            ...
            <div class="row margin_top_30">
               <div class="col-md-12">
                  <div class="button_section full center margin_top_30">
                     <a style="margin:0;" href="about.php">Conocer más</a>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="full blog_cont">
                     ...
                     <p ALIGN="JUSTIFY" class="white_font">A través de nuestro Petshop puedes otorgar a tu mascota la oportunidad de crecer
                        fuerte y sana al adquirir las mejores marcas de alimentos para perros, gatos, roedores y peces. Adquiere
                        alimentos especiales para cada etapa de vida de tu mascota, así como para cada raza...</p>
                  </div>
               </div>
            </div>
         </div>
